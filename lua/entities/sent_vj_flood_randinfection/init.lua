...
ENT.EntitiesToSpawn = {
	{EntityName = "NPC1",SpawnPosition = {vForward=25,vRight=0,vUp=0},Entities = ent_tbl},
	{EntityName = "NPC2",SpawnPosition = {vForward=0,vRight=50,vUp=0},Entities = ent_tbl},
	...
	{EntityName = "NPC5",SpawnPosition = {vForward=0,vRight=-50,vUp=0},Entities = ent_tbl},
}
/*-----------------------------------------------
	*** Copyright (c) 2012-2016 by Cpt. Hazama, All rights reserved. ***
	No parts of this code or any of its contents may be reproduced, copied, modified or adapted, 
