...
SWEP.WorldModel					= "models/cpthazama/halo3fl/plasmarifle.mdl"
SWEP.HoldType 					= "ar2"
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"vj_halo3flood/plasmarifle.wav"}
SWEP.NPC_ReloadSound			= {"vj_halo3flood/plasmarifle_overheat.wav"}
