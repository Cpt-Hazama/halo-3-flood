...
SWEP.WorldModel					= "models/cpthazama/halo3/weapons/rpg.mdl"
SWEP.AnimationType 				= "Support_High"
SWEP.HoldType 					= "rpg"
	-- NPC Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.NPC_NextPrimaryFire 		= 8 -- Next time it can use primary fire
SWEP.NPC_TimeUntilFire	 		= 0.001 -- How much time until the bullet/projectile is fired?
SWEP.NPC_ExtraFireSound = {
	"vj_halo3flood/weapons/fp_rl_fire1.wav",
	"vj_halo3flood/weapons/fp_rl_fire2.wav",
	"vj_halo3flood/weapons/fp_rl_fire3.wav",
}
SWEP.NPC_ReloadSound = {"vj_halo3flood/weapons/fp_rl_reload1.wav"}
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {
	"vj_halo3flood/weapons/rocket_h3_1.wav",
	"vj_halo3flood/weapons/rocket_h3_2.wav",
	"vj_halo3flood/weapons/rocket_h3_3.wav",
	"vj_halo3flood/weapons/rocket_h3_4.wav",
}
...
SWEP.WorldModel_CustomPositionOrigin = Vector(-3,-1.2,-0.7)
	-- Reload Settings ---------------------------------------------------------------------------------------------------------------------------------------------
